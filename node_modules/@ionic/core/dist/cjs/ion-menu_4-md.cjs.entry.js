...
const core = require('./core-7bdde4bb.js');
const config = require('./config-773d6543.js');
const animation = require('./animation-77f06c37.js');
const index = require('./index-54b638ff.js');
const theme = require('./theme-9139efee.js');
const helpers = require('./helpers-ddb8d8a0.js');
const cubicBezier = require('./cubic-bezier-816e123c.js');
...
const Menu = class {
    ...
    async componentWillLoad() {
        if (this.type === undefined) {
            this.type = config.config.get('menuType', this.mode === 'ios' ? 'reveal' : 'overlay');
        }
        ...
        this.gesture = (await new Promise(function (resolve) { resolve(require('./index-54b638ff.js')); })).createGesture({
            el: document,
    ...
    onEnd(detail) {
         ...
         */
        newStepValue += cubicBezier.getTimeGivenProgression(new cubicBezier.Point(0, 0), new cubicBezier.Point(0.4, 0), new cubicBezier.Point(0.6, 1), new cubicBezier.Point(1, 1), stepValue);
        this.animation
    ...
    render() {
        ...
        return (core.h(core.Host, { role: "navigation", class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
            ...
            } }, core.h("div", { class: "menu-inner", ref: el => this.menuInnerEl = el }, core.h("slot", null)), core.h("ion-backdrop", { ref: el => this.backdropEl = el, class: "menu-backdrop", tappable: false, stopPropagation: false })));
    }
...
const MenuButton = class {
    ...
    render() {
        ...
        const menuIcon = config.config.get('menuIcon', 'menu');
...
const MenuController = class {
    ...
    async _createAnimation(type, menuCmp) {
        ...
        if (!config.config.getBoolean('animated', true)) {
