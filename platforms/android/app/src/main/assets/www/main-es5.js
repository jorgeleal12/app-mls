...
var AcountServicePage = /** @class */ (function () {
    function AcountServicePage(loginServiceService, toastController, modalController, navParams) {
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.createDatabase = function () {
        ...
        this.sqlite.create({
            ...
            return _this.tasksService.createTableImage();
        })
            .then(function () {
        })
            .catch(function (error) {
...
var BuilderPage = /** @class */ (function () {
    function BuilderPage(LoginServiceService, modalController) {
        this.LoginServiceService = LoginServiceService;
        this.modalController = modalController;
        this.builders = [];
        this.isSearchbarOpened = false;
    ...
    BuilderPage.prototype.search = function () {
        var _this = this;
        this.LoginServiceService.search_builder().subscribe(function (result) {
...
var ClientServicePage = /** @class */ (function () {
    function ClientServicePage(LoginServiceService, router, modalController) {
        this.LoginServiceService = LoginServiceService;
        this.router = router;
        this.modalController = modalController;
        this.Clients = [];
    ...
    ClientServicePage.prototype.ListClient = function (event) {
        var _this = this;
        var params = { idcompany: 1 };
        this.LoginServiceService.ListClient(this.page).subscribe(function (result) {
...
var MaterialsPage = /** @class */ (function () {
    function MaterialsPage(LoginServiceService, modalController) {
        this.LoginServiceService = LoginServiceService;
        this.modalController = modalController;
        this.materials = [];
        this.isSearchbarOpened = false;
    ...
    MaterialsPage.prototype.search = function () {
        var _this = this;
        this.LoginServiceService.search_materials().subscribe(function (result) {
