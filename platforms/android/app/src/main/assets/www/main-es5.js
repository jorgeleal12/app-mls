...
var SendimagesPage = /** @class */ (function () {
    function SendimagesPage(route, router, imagePicker, transfer, file, loadingController, fileChooser, navParams, modalController, camera, actionSheetController, toastController) {
        var _this = this;
        this.route = route;
        this.router = router;
