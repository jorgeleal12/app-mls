...
var LoginServiceService = /** @class */ (function () {
    function LoginServiceService(http) {
        this.http = http;
        this.api_url = 'http://190.0.33.166:90/laravel-mls/public/api/';
    }
...
var SendimagesPage = /** @class */ (function () {
    ...
    SendimagesPage.prototype.onLoadimage = function (img, id, name_photo, idodi, tipe, contract_idcontract) {
        ...
        source.onload = function () {
            ...
            fileTransfer
                .upload(imagen, "http://190.0.33.166:90/laravel-mls/public/api/odi/send_image_movil", options)
                .then(function (data) {
