...
var AsignadasPage = /** @class */ (function () {
    function AsignadasPage(LoginServiceService, router, loadingController, tasksService, transfer, file) {
    ...
    AsignadasPage.prototype.ionViewWillEnter = function () {
        this.sqli();
    ...
    AsignadasPage.prototype.search_asignadas = function () {
        ...
        this.LoginServiceService.seach_asignadas(params).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["finalize"])(function () {
    ...
    AsignadasPage.prototype.showLoader = function () {
    ...
    AsignadasPage.prototype.sqli = function () {
        var _this = this;
    ...
    AsignadasPage.prototype.sendimage = function () {
        for (var _i = 0, _a = this.image; _i < _a.length; _i++) {
            var data = _a[_i];
            console.log(data);
            this.onLoadimage(data.name_photo, data.odi_idodi, data.idphotos, data.certifications);
        }
    };
    AsignadasPage.prototype.onLoadimage = function (name_photo, odi_idodi, idphotos, certifications) {
        var params = {
            idodi: odi_idodi,
            tipe: idphotos,
        ...
        var imagen = filePath + name_photo;
        console.log(imagen);
        var options = {
            fileKey: "file",
            fileName: 'name.jpg',
